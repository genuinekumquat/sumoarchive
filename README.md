...
한국어로 오오즈모(大相撲) 정보를 편하게 찾아보는 아카이브 웹 서비스입니다.

---

## 1. 기획 의도

일본 스모(오오즈모)는 반즈케(番付)·시코나(四股名)·키마리테(決まり手) 등 고유 용어가 많고,
...
1. **메인 화면**에서 로그인 없이 바로 최신 마쿠우치(幕內) 반즈케를 확인하고, 디비전 탭(마쿠우치/주료/
   마쿠시타/산단메/조니단/조노구치)을 눌러 다른 급의 반즈케를 비동기로 불러올 수 있다.
